...
$data = mysqli_fetch_assoc($libros);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <a type="button" class="btn btn-secondary" href="admin/login.php" type="button">Ingresar</a>
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div class="offcanvas-body">
                    <div>
                        Lista de libros digitales.
                    </div><br>
                    <?php foreach ($libros as $dat):?>
                        <a class="btn" style="text-align: left;" href="#<?php echo $dat["titulo"]; ?>" type="button"> <img src="https://img.icons8.com/cotton/24/000000/read.png" /> <?php echo $dat["titulo"]; ?></a><br><br>
                    <?php endforeach; ?>
                </div>
            </div>
        </div>
                ...
                <table class="table" id="libros">
                    ...
                    <tbody>
                        <?php foreach ($libros as $dat) : ?>
                            <tr>
                                <th>
                                    <h5 style="display: none;"><?php echo $dat["Id_libro"]; ?></h5>
                                    <h5 style="display: none;"><?php echo $dat["titulo"]; ?></h5>
                                    <div class="card border-secondary mb-6" style="max-width: 800px;">
                                        <div class="row g-1">
                                            <div class="col-md-4">
                                                <img src="archivos/<?php echo $dat["img"]; ?>" class="img-fluid rounded-start" alt="...">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title"><?php echo $dat["titulo"]; ?></h5>
                                                    <p class="card-text"><?php echo $dat["autor"]; ?></p>
                                                    <p style="text-align: justify;" class="card-text"><small class="text-muted"><?php echo $dat["descripcion"]; ?></small></p>
                                                </div>
                                            </div>
                                            <center><a class="btn btn-danger" href="admin/login1.php?Id_libro=<?php echo $dat["Id_libro"]; ?>">Leer</a></center><br><br>
                                        </div>
                                    </div><br>
                                </th>
                            </tr> <?php endforeach; ?> 
    ...
    <!-- Fin contenido-->
    <!-- Scripts -->
    <script type="text/javascript" src="admin/login1.js"></script>
